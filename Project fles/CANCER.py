...
np.random.seed(42)
skin_df = pd.read_csv('C:\\Users\\dilav\\Documents\\dataverse_files\\HAM10000_metadata.csv')
...
image_path = {os.path.splitext(os.path.basename(x))[0]: x
              for x in glob(os.path.join('C:\\Users\\dilav\\Documents\\dataverse_files\\HAM10000_images_part_1\\', '*', '*.jpg'))}
